...
class DressingOrmagazinesScreen extends StatefulWidget {
  static String routeName = "/dressing_or_magazins";
  final String title="";

  const DressingOrmagazinesScreen({Key? key}) : super(key: key);
  @override
  _DressingOrmagazinesScreen createState() => _DressingOrmagazinesScreen();
}

class _DressingOrmagazinesScreen extends State<DressingOrmagazinesScreen> {
